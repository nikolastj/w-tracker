...
// src/app/shared/components/confirm-action-dialog.component.ts
var ConfirmActionDialogData = class {
  title;
  message;
  confirmText;
  cancelText;
...
var ConfirmActionDialogComponent = class _ConfirmActionDialogComponent {
  dialogRef = inject(MatDialogRef);
  data = new ConfirmActionDialogData();
  onConfirm() {
  ...
  static \u0275fac = function ConfirmActionDialogComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ConfirmActionDialogComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfirmActionDialogComponent, selectors: [["app-confirm-action-dialog"]], decls: 12, vars: 5, consts: [[1, "p-6"], [1, "mb-4"], [1, "text-xl", "font-semibold"], [1, "mb-6"], [1, "leading-relaxed", "text-gray-600"], [1, "flex", "justify-end", "gap-3"], ["mat-stroked-button", "", 1, "px-6", 3, "click"], ["mat-raised-button", "", 1, "px-6", 3, "click", "color"]], template: function ConfirmActionDialogComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function ConfirmActionDialogComponent_Template_button_click_8_listener() {
        return ctx.onCancel();
      });
      \u0275\u0275text(9);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(10, "button", 7);
      \u0275\u0275listener("click", function ConfirmActionDialogComponent_Template_button_click_10_listener() {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", ctx.data.cancelText, " ");
      \u0275\u0275advance();
      \u0275\u0275property("color", ctx.data.confirmButtonColor);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", ctx.data.confirmText, " ");
    }
  }, dependencies: [CommonModule, MatDialogModule, MatButtonModule, MatButton, MatIconModule], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ConfirmActionDialogComponent, [{
    type: Component,
    args: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfirmActionDialogComponent, { className: "ConfirmActionDialogComponent", filePath: "src/app/shared/components/confirm-action-dialog.component.ts", lineNumber: 55 });
})();

// src/app/shared/directives/auto-scroll-to-bottom.directive.ts
var AutoScrollToBottomDirective = class _AutoScrollToBottomDirective {
  elementRef;
  scrollDelay = 100;
  ...
  static \u0275fac = function AutoScrollToBottomDirective_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AutoScrollToBottomDirective)(\u0275\u0275directiveInject(ElementRef));
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({ type: _AutoScrollToBottomDirective, selectors: [["", "appAutoScrollToBottom", ""]], inputs: { scrollDelay: "scrollDelay" } });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AutoScrollToBottomDirective, [{
    type: Directive,
    args: [{
      selector: "[appAutoScrollToBottom]",
      standalone: true
    }]
  }], () => [{ type: ElementRef }], { scrollDelay: [{
    type: Input
  }] });
})();

// src/app/shared/directives/scroll-to-top-detector.directive.ts
var ScrollToTopDetectorDirective = class _ScrollToTopDetectorDirective {
  elementRef;
  scrolledToTop = new EventEmitter();
  isInitialized = false;
  initDelay = 500;
  // Delay to avoid triggering during auto-scroll initialization
  constructor(elementRef) {
    this.elementRef = elementRef;
  }
  ngOnInit() {
  ...
  static \u0275fac = function ScrollToTopDetectorDirective_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ScrollToTopDetectorDirective)(\u0275\u0275directiveInject(ElementRef));
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({ type: _ScrollToTopDetectorDirective, selectors: [["", "appScrollToTopDetector", ""]], hostBindings: function ScrollToTopDetectorDirective_HostBindings(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275listener("scroll", function ScrollToTopDetectorDirective_scroll_HostBindingHandler($event) {
        return ctx.onScroll($event);
      });
    }
  }, outputs: { scrolledToTop: "scrolledToTop" } });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ScrollToTopDetectorDirective, [{
    type: Directive,
    args: [{
      selector: "[appScrollToTopDetector]",
      standalone: true
    }]
  }], () => [{ type: ElementRef }], { scrolledToTop: [{
    type: Output
  }], onScroll: [{
    type: HostListener,
    args: ["scroll", ["$event"]]
...
// src/app/shared/services/muscle-data.service.ts
var MuscleDataService = class _MuscleDataService extends CacheResponseService {
  http;
  notificationService;
  ...
  getMuscleData() {
    return this.getWithCache("muscles", {}, () => this.http.get(`${this.API_URL}/muscles`).pipe(handleNotifications({
      errorMessage: "Failed to load muscle data. Please try again.",
      notificationService: this.notificationService
    })));
  }
  static \u0275fac = function MuscleDataService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MuscleDataService)(\u0275\u0275inject(HttpClient), \u0275\u0275inject(NotificationService));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _MuscleDataService, factory: _MuscleDataService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MuscleDataService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
// src/app/features/timeline/timeline-calendar/timeline-calendar.component.ts
var _c03 = ["timelineBody"];
function TimelineCalendarComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
var MondayFirstDateAdapter = class _MondayFirstDateAdapter extends NativeDateAdapter {
  ...
  static \u0275fac = /* @__PURE__ */ (() => {
    let \u0275MondayFirstDateAdapter_BaseFactory;
    return function MondayFirstDateAdapter_Factory(__ngFactoryType__) {
      return (\u0275MondayFirstDateAdapter_BaseFactory || (\u0275MondayFirstDateAdapter_BaseFactory = \u0275\u0275getInheritedFactory(_MondayFirstDateAdapter)))(__ngFactoryType__ || _MondayFirstDateAdapter);
    };
  })();
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _MondayFirstDateAdapter, factory: _MondayFirstDateAdapter.\u0275fac });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MondayFirstDateAdapter, [{
    type: Injectable
  }], null, null);
})();
var TimelineCalendarComponent = class _TimelineCalendarComponent {
  timelineBody;
  calendars;
  calendarMonths = [];
  ...
  constructor() {
    effect(() => {
      ...
      if (filter2?.fromDate && filter2?.toDate) {
  ...
  preserveScrollPositionDuringUpdate() {
  ...
  generateCalendarMonths() {
    ...
    if (!filter2?.fromDate || !filter2?.toDate)
      return;
    const startDate = filter2.fromDate;
    const endDate = filter2.toDate;
    ...
    const existingMonthKeys = new Set(this.calendarMonths.map((month) => `${month.getFullYear()}-${month.getMonth()}`));
    const newMonths = requiredMonths.filter((month) => !existingMonthKeys.has(`${month.getFullYear()}-${month.getMonth()}`));
    this.calendarMonths = [...this.calendarMonths, ...newMonths].sort((a, b) => a.getTime() - b.getTime());
  }
  static \u0275fac = function TimelineCalendarComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _TimelineCalendarComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TimelineCalendarComponent, selectors: [["app-timeline-calendar"]], viewQuery: function TimelineCalendarComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuery(_c03, 5);
      \u0275\u0275viewQuery(MatCalendar, 5);
    }
    ...
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(1, TimelineCalendarComponent_Conditional_1_Template, 1, 0, "app-loader", 2);
      \u0275\u0275elementStart(2, "div", 3);
      \u0275\u0275element(3, "mat-calendar", 4);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "div", 5, 0);
      \u0275\u0275listener("scrolledToTop", function TimelineCalendarComponent_Template_div_scrolledToTop_4_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onScrolledToTop());
      });
      \u0275\u0275repeaterCreate(6, TimelineCalendarComponent_For_7_Template, 7, 4, "div", 6, ctx.trackByMonth, true);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TimelineCalendarComponent, [{
    type: Component,
    args: [{ selector: "app-timeline-calendar", standalone: true, imports: [
      CommonModule,
      MatDatepickerModule,
      MatNativeDateModule,
      MatCardModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TimelineCalendarComponent, { className: "TimelineCalendarComponent", filePath: "src/app/features/timeline/timeline-calendar/timeline-calendar.component.ts", lineNumber: 46 });
})();

// src/app/features/timeline/workouts-timeline.component.ts
var WorkoutsTimelineComponent = class _WorkoutsTimelineComponent {
  workoutsService;
  workoutsData = [];
  ...
  dateFilter = signal({
    ...
    toDate: new Date((/* @__PURE__ */ new Date()).setHours(23, 59, 59, 999))
  }, ...ngDevMode ? [{ debugName: "dateFilter" }] : []);
  // Workout dates for calendar highlighting
  workoutDates = signal([], ...ngDevMode ? [{ debugName: "workoutDates" }] : []);
  ...
  loadWorkouts(filter2, isPrevious = false) {
    this.loading.set(true);
    filter2.pageSize = 120;
    this.workoutsService.getPaginatedWorkouts(filter2).pipe(delay(isPrevious ? 500 : 1e3)).subscribe({
      next: (data) => {
        const workouts = data.data || [];
        this.workoutsData = [...this.workoutsData, ...workouts];
        this.workoutDates.set(this.workoutsData.map((workout) => ({
          id: workout.id,
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WorkoutsTimelineComponent, selectors: [["app-workouts-timeline"]], outputs: { workoutSelected: "workoutSelected" }, decls: 2, vars: 3, consts: [[1, "h-full", "w-full"], [3, "scrolledToTop", "workoutDateClicked", "loading", "dateFilter", "workoutDates"]], template: function WorkoutsTimelineComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275advance();
      \u0275\u0275property("loading", ctx.loading())("dateFilter", ctx.dateFilter())("workoutDates", ctx.workoutDates());
    }
  }, dependencies: [CommonModule, TimelineCalendarComponent], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(WorkoutsTimelineComponent, [{
    type: Component,
    args: [{
