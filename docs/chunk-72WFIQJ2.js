...
// src/app/core/services/color-scheme.service.ts
var ColorSchemeService = class _ColorSchemeService {
  rendererFactory;
  renderer;
  darkModeMediaQuery;
  ...
  applyColorScheme(scheme) {
    ...
    if (bodyElement) {
      ...
      this.renderer.setAttribute(document.documentElement, "data-theme", scheme);
  ...
  removeColorSchemeListener() {
    if (this.darkModeMediaQuery.removeEventListener) {
      this.darkModeMediaQuery.removeEventListener("change", this.handleColorSchemeChange.bind(this));
    } else {
  ...
  static \u0275fac = function ColorSchemeService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ColorSchemeService)(\u0275\u0275inject(RendererFactory2));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ColorSchemeService, factory: _ColorSchemeService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ColorSchemeService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
//# sourceMappingURL=chunk-72WFIQJ2.js.map
