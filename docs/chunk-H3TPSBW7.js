...
var PublicHeaderComponent = class _PublicHeaderComponent {
  ...
  static \u0275fac = function PublicHeaderComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _PublicHeaderComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PublicHeaderComponent, selectors: [["app-public-header"]], decls: 28, vars: 7, consts: [["publicMenu", "matMenu"], [1, "header-container"], ["color", "primary", 1, "shadow-sm"], [1, "header-title", "flex-1"], [1, "header-actions"], ["mat-icon-button", "", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], ["mat-menu-item", "", "routerLink", "/auth/login"], ["mat-menu-item", "", "routerLink", "/auth/register"]], template: function PublicHeaderComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      ...
      \u0275\u0275text(7, "menu");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(8, "mat-menu", null, 0)(10, "button", 6);
      \u0275\u0275listener("click", function PublicHeaderComponent_Template_button_click_10_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275elementStart(18, "button", 7)(19, "mat-icon");
      \u0275\u0275text(20, "login");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(21, "span");
      \u0275\u0275text(22, "Sign In");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(23, "button", 8)(24, "mat-icon");
    ...
    if (rf & 2) {
      const publicMenu_r2 = \u0275\u0275reference(9);
      \u0275\u0275advance(5);
      \u0275\u0275property("matMenuTriggerFor", publicMenu_r2);
      \u0275\u0275advance(7);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(13, 3, ctx.currentTheme$) === "dark" ? "light_mode" : "dark_mode");
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(16, 5, ctx.currentTheme$) === "dark" ? "Light Mode" : "Dark Mode");
    }
  }, dependencies: [
    CommonModule,
    RouterModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PublicHeaderComponent, [{
    type: Component,
    args: [{ selector: "app-public-header", standalone: true, imports: [
      CommonModule,
      RouterModule,
      MatToolbarModule,
      MatButtonModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PublicHeaderComponent, { className: "PublicHeaderComponent", filePath: "src/app/shared/components/public-header.component.ts", lineNumber: 58 });
})();
...
//# sourceMappingURL=chunk-H3TPSBW7.js.map
