...
var authRoutes = [
  {
    ...
    children: [
      {
        path: "login",
        loadComponent: () => import("./login.component-MZSRZ3HY.js").then((m) => m.LoginComponent)
      },
      {
        path: "register",
        loadComponent: () => import("./register.component-BE3VUZNE.js").then((m) => m.RegisterComponent)
      },
      {
        path: "forgot-password",
        loadComponent: () => import("./forgot-password.component-LBSR4754.js").then((m) => m.ForgotPasswordComponent)
      }
    ]
  }
];
...
//# sourceMappingURL=auth.module-XKKAEE4A.js.map
